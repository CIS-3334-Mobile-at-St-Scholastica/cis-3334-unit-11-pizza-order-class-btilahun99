...
class PizzaDialog extends StatefulWidget {
  const PizzaDialog({Key key}) : super(key: key);

  @override
  State<PizzaDialog> createState() => _PizzaDialogState();
}

class _PizzaDialogState extends State<PizzaDialog> {
